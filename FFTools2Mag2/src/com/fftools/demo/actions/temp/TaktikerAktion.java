 ...
 * @version
 */
public class TaktikerAktion extends MenuAction {
	 ...
	 */
	public TaktikerAktion(SelectionObserver selectionObserver) {
        super(selectionObserver.getClient());
        setName("Temp: Taktiker");
	...
	private void makeIt(Unit u){
		...
		// name setzen
		tempUnit.addOrder("BENENNEN EINHEIT Denker ;dnt");
		// script Setzen
		tempUnit.addOrder("// script Lernfix Talent=Taktik");
		...
		tempUnit.addOrder("Rekrutiere 1");
