 ...
 * @version
 */
public class tempZupferAction extends MenuAction {
	 ...
	 */
	public tempZupferAction(SelectionObserver selectionObserver) {
	...
	private void makeIt(Unit u){
		...
		// name setzen
		tempUnit.addOrder("BENENNEN EINHEIT Zupfer ;dnt");
		// script Setzen
