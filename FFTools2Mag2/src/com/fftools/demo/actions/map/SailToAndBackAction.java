 ...
 * @version
 */
public class SailToAndBackAction extends MenuAction {
	...
	public void setTargetRegion(Region targetRegion) {
		...
		command = "// script SailTo " + targetRegion.getCoordX()+","+targetRegion.getCoordY()+" ;" + targetRegion.getName() + " and back"; 
		setName(command);
	 ...
	 */
	public SailToAndBackAction(SelectionObserver selectionObserver) {
        super(selectionObserver.getClient());
        setName("// script SailTo");
        this.selectionObserver = selectionObserver; 
        this.data = this.selectionObserver.getClient().getData();
        log = Logger.getInstance(SailToAndBackAction.class);
	...
	private void Goto(Unit u){
	   ...
	   String order = "nix";
	    ...
	    command = "// script SailTo " + targetRegion.getCoordX()+","+targetRegion.getCoordY();
	    command += " " + u.getRegion().getCoordX() + "," + u.getRegion().getCoordY();
	    command += " ;" + targetRegion.getName() + " (and back)";
