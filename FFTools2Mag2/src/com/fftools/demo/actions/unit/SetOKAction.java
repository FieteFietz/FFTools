 ...
 * @version
 */
public class SetOKAction extends MenuAction {
	 ...
	 */
	public SetOKAction(SelectionObserver selectionObserver) {
	...
	private void doAction(Unit u){
		String order = "// setOK " + this.selectionObserver.getClient().getData().getDate().getDate();
		u.addOrder( order);
