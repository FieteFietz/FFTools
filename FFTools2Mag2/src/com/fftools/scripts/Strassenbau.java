...
public void runScript(int scriptDurchlauf){
	...
	private void run1(){
		...
		this.addComment("Strassenbau-Einstellungen: " + this.AnzahlStrassen + " Strassen mit Prio " + this.PrioStrassen + ", " + this.AnzahlGebäude + " Gebäude mit Prio " + this.PrioGebäude );
					...
					if (koords.length==2) {
						...
						if (actDest!=null) {
							...
							if (TA!=null){
								...
								this.addComment("Strassenbau: notIn erkannt für: " + actR.toString());
							} else {
