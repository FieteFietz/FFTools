	...
	public static void main(String[] args) {
		try {
	        ...
	        if (settings == null) {
	          ...
	          // settings.setProperty(PropertiesHelper.ADVANCEDSHAPERENDERER_S_SETS,",Einkaufsgut");
	          // settings.setProperty(PropertiesHelper.ADVANCEDSHAPERENDERER_S_CURRENT_SET,"Einkaufsgut");
